		...
		<el-dialog v-model="formVisible" :title="formTitle" width="80%" destroy-on-close :fullscreen='false'>
			<el-form class="formModel_form" ref="formRef" :model="form" label-width="$template2.back.add.form.base.labelWidth" :rules="rules">
				<el-row>
					...
					<el-col :span="12">
						<el-form-item label="已打卡" prop="yidaka">
							<el-input class="list_inp" v-model.number="form.yidaka" placeholder="已打卡"
								 type="text" 								:readonly="!isAdd||disabledForm.yidaka?true:false" />
						</el-form-item>
					</el-col>

					<el-col :span="12">
						<el-form-item label="未打卡" prop="weidaka">
							<el-input class="list_inp" v-model.number="form.weidaka" placeholder="未打卡"
								 type="text" 								:readonly="!isAdd||disabledForm.weidaka?true:false" />
						</el-form-item>
					</el-col>
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='yidaka'){
					form.value.yidaka = row[x];
					disabledForm.value.yidaka = true;
					continue;
				}
				if(x=='weidaka'){
					form.value.weidaka = row[x];
					disabledForm.value.weidaka = true;
					continue;
				}
			}
			if(row){
